...
var codes = [
  ...
  { name: "The Bahamas", dial_code: "+1 242", code: "BS" },
  ...
  { name: "The Central African Republic", dial_code: "+236", code: "CF" },
  ...
  { name: "The Dominican Republic", dial_code: "+1 849", code: "DO" },
  ...
  { name: "The Netherlands", dial_code: "+31", code: "NL" },
  ...
  { name: "The Philippines", dial_code: "+63", code: "PH" },
  ...
  { name: "The United Arab Emirates", dial_code: "+971", code: "AE" },
  {
    name: "The United Kingdom Of Great Britain And Northern Ireland",
    dial_code: "+44",
    code: "GB",
  },
  { name: "The United States of America", dial_code: "+1", code: "US" },
  ...
  { name: "Islamic Republic Of Iran", dial_code: "+98", code: "IR" },
  { name: "Isle of Man", dial_code: "+44", code: "IM" },
  { name: "Jersey", dial_code: "+44", code: "JE" },
  { name: "The Republic Of Korea", dial_code: "+850", code: "KP" },
  { name: "Korea, Republic of", dial_code: "+82", code: "KR" },
  { name: "Lao People's Democratic Republic", dial_code: "+856", code: "LA" },
  { name: "Libyan Arab Jamahiriya", dial_code: "+218", code: "LY" },
  { name: "Macao", dial_code: "+853", code: "MO" },
  { name: "Republic Of North Macedonia", dial_code: "+389", code: "MK" },
  { name: "Micronesia, Federated States of", dial_code: "+691", code: "FM" },
  { name: "The Republic Of Moldova", dial_code: "+373", code: "MD" },
  { name: "Mozambique", dial_code: "+258", code: "MZ" },
  { name: "State Of Palestine", dial_code: "+970", code: "PS" },
  { name: "Pitcairn", dial_code: "+872", code: "PN" },
  { name: "Réunion", dial_code: "+262", code: "RE" },
  { name: "The Russian Federation", dial_code: "+7", code: "RU" },
...
function getCountryCode(countryName) {
  let code = codes.find((o) => o.name.match(RegExp(countryName, "i")));
  if (code == null) {
    return "";
  } else {
    return "https://flagcdn.com/16x12/" + code.code.toLowerCase() + ".png";
  }
}
